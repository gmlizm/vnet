...
public class AesUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		final IvParameterSpec iv = new IvParameterSpec(getUTF8Bytes("1234567890123457"));
		...
		try (CryptoCipher encipher = Utils.getCipherInstance(transform, properties)) {
			...
			inBuffer.put(getUTF8Bytes("hello world!ljdfqewjrpowqijtrlqwkejfgsadgfdsaaa"));
	...
	private ByteBuffer aesFinal()  throws Exception {
		final SecretKeySpec key = new SecretKeySpec(getUTF8Bytes("1234567890123456"), "AES");
