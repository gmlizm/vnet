 ...
 * 
 * @author wb-tianyc
 * @version $Id: StringEscapeUtil.java,v 0.1 2010-7-6 上午09:41:49 wb-tianyc Exp $
 */
public class StringEscapeUtil {
	private static final String DEFAULT_CHARSET = System
			.getProperty("defaultCharset") == null ? "UTF-8" : System
	 ...
	 *             如果输出失败
	 */
	public static void escapeJava(final String str, final Writer out)
			throws IOException {
	 ...
	 *             如果输出失败
	 */
	public static void escapeJavaScript(final String str, final Writer out)
			throws IOException {
	...
	private static String escapeJavaStyleString(final String str,
			final boolean escapeSingleQuotes, final boolean strict) {
		if (str == null) {
			return null;
		}
	 ...
	 */
	private static boolean escapeJavaStyleString(final String str,
			final boolean escapeSingleQuote, final Writer out,
			final boolean strict) throws IOException {
	 ...
	 *             如果输出失败
	 */
	public static void unescapeJava(final String str, final Writer out)
			throws IOException {
	 ...
	 *             如果输出失败
	 */
	public static void unescapeJavaScript(final String str, final Writer out)
			throws IOException {
		unescapeJavaStyleString(str, out);
	}
	 ...
	 *             如果输出失败
	 */
	private static boolean unescapeJavaStyleString(final String str,
	 ...
	 */
	public static String escapeURL(final String str, final String encoding)
			throws UnsupportedEncodingException {
	 ...
	 */
	public static String escapeURL(final String str, final String encoding,
			final boolean strict) throws UnsupportedEncodingException {
	 ...
	 */
	public static void escapeURL(final String str, final String encoding,
			final Writer out) throws IOException {
	 ...
	 */
	public static void escapeURL(final String str, final String encoding,
			final Writer out, final boolean strict) throws IOException {
	 ...
	 *             如果指定的<code>encoding</code>为非法的
	 */
	private static String escapeURLInternal(final String str,
			final String encoding, final boolean strict)
			throws UnsupportedEncodingException {
		if (str == null) {
			return null;
		}
	 ...
	 *             <code>out</code>为<code>null</code>
	 */
	private static boolean escapeURLInternal(final String str, String encoding,
			final Writer out, final boolean strict) throws IOException {
		if (encoding == null) {
	 ...
	 *             如果指定的<code>encoding</code>为非法的
	 */
	public static String unescapeURL(final String str, final String encoding)
			throws UnsupportedEncodingException {
	 ...
	 *             <code>out</code>为<code>null</code>
	 */
	public static void unescapeURL(final String str, final String encoding,
			final Writer out) throws IOException {
	 ...
	 *             如果指定的<code>encoding</code>为非法的
	 */
	private static String unescapeURLInternal(final String str,
	 ...
	 *             <code>out</code>为<code>null</code>
	 */
	private static boolean unescapeURLInternal(final String str,
			String encoding, final Writer out) throws IOException {
		if (encoding == null) {
			encoding = DEFAULT_CHARSET;
		}
		...
		for (int i = 0; i < length; i++) {
			...
			if (ch < 256) {
				...
				case '%':
					...
					if ((i + 2) < length) {
						try {
							buffer[pos] = (byte) Integer.parseInt(
