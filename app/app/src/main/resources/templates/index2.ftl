...
<!-- <div class="header">
	<div class="header_top">
		<div class="container">
			<div class="logo">
				<a href="index.htm"><img src="/images/logo.png" width="210" alt=""/></a>
			</div>
			<ul class="shopping_grid">
			      <a href="#"><li>QQ登录</li></a>
			      <a href="login.htm"><li>淘宝登录</li></a>
	...
	<div class="h_menu4">start h_menu4
		<div class="container">
				...
				<ul class="nav">
					<li class="active"><a href="/index.htm" data-hover="Home">主页</a></li>
					<li><a href="careers.htm" data-hover="Careers">Careers</a></li>
					<li><a href="contact.htm" data-hover="Contact Us">Contact Us</a></li>
					<li><a href="404.htm" data-hover="Company Profile">Company Profile</a></li>
					...
					<li><a href="about.htm" data-hover="About Us">关于我们</a></li>
				 </ul>
  	...
  	<div class="container">
	   ...
	   <div class="col-md-9 content_right">
	     ...
	     <div class="col-md-4 box_2">
	     	<div class="grid_1"><a href="single.htm">
	     ...
	     <div class="col-md-8 box_1"><a href="single.htm">
	       <div class="grid_1">
	     	  <div class="b-link-stroke b-animate-go  thickbox">
	    ...
	    <div class="top_grid2">
	      <div class="col-md-4 top_grid1-box1"><a href="single.htm">
	     	<div class="grid_1">
	     	  <div class="b-link-stroke b-animate-go  thickbox">
